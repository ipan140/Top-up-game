    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/dashboard') }}">
                <div class="sidebar-brand-text mx-3 fs-3 fw-bold">
                    Tokomu.
                </div>
            </a>
            ...
            <li
                class="nav-item {{ Nav::isRoute(['categories.index', 'games.index', 'topup_types.index', 'topup_transactions.index']) ? 'active' : '' }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseGame"
                    aria-expanded="true" aria-controls="collapseGame">
                    <i class="fas fa-fw fa-gamepad"></i>
                    <span>{{ __('Kelola Game') }}</span>
                </a>
                <div id="collapseGame"
                    class="collapse {{ Nav::isRoute(['categories.index', 'games.index', 'topup_types.index', 'topup_transactions.index']) ? 'show' : '' }}"
